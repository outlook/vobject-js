...
module.exports = (function() {
  ...
  self.parseComponent = function(componentStr) {
    ...
    case 'VCALENDAR':
      var calendarComponent = vobject.calendar();
      return calendarComponent;

    case 'VEVENT':
      var eventComponent = vobject.event();
      return eventComponent;

    case 'VTODO':
      var todoComponent = vobject.todo();
      return todoComponent;

    case 'VALARM':
      var alarmComponent = vobject.alarm();
  ...
  self.parseProperty = function(propertyStr) {
    ...
    switch (propertyName) {
    case 'ATTENDEE':
      var attendeeProperty = vobject.attendee();
      attendeeProperty.parseICS(propertyStr);
      return attendeeProperty;

    case 'ORGANIZER':
      var organizerProperty = vobject.organizer();
