...
module.exports = function() {
  ...
  event.setProperty(new Property('SEQUENCE', '0'));
  ...
  event.setSummary = function(summary) {
    event.setProperty(new Property('SUMMARY', summary));
  };
  ...
  event.setDTStart = function(date) {
    ...
    property.setParameter('VALUE', date.isDate ? 'DATE' : 'DATE-TIME');
  ...
  event.setDescription = function(description) {
    event.setProperty(new Property('DESCRIPTION', description));
  };
  ...
  event.setStatus = function(status) {
    event.setProperty(new Property('STATUS', status));
  };
