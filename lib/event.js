...
module.exports = function() {
  ...
  event.setDTStamp = function(value) {
    event.setPropertyWithNameAndValue('DTSTAMP', value.toICS());
  };
  ...
  event.setDTStart = function(value) {
    var property = Property('DTSTART', value.toICS());
    property.setParameter('VALUE', value.isDate ? 'DATE' : 'DATE-TIME');
  ...
  event.setDTEnd = function(value) {
    var property = Property('DTEND', value.toICS());
    property.setParameter('VALUE', value.isDate ? 'DATE' : 'DATE-TIME');
    event.pushProperty(property);
  };
  ...
  event.addRRule = function(value) {
    event.pushPropertyWithNameAndValue('RRULE', value);
  };
