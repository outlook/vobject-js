...
module.exports = function() {
  ...
  alarm.setAction = function(action) {
    return alarm.setProperty(new Property('ACTION', action.toUpperCase()));
  };
  ...
  alarm.setDescription = function(description) {
    return alarm.setProperty(new Property('DESCRIPTION', description));
  };
  ...
  alarm.setTrigger = function(trigger) {
    ...
    return alarm.setProperty(property);
  };
