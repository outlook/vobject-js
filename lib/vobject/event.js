...
module.exports = function() {
  ...
  event.getDTStart = function() {
    return event.getProperty('DTSTART');
  };
  ...
  event.getDTEnd = function() {
    return event.getProperty('DTEND');
  };
  ...
  event.setLocation = function(location) {
    event.setProperty(new Property('LOCATION', escape(location)));
  };
  ...
  event.getLastModified = function() {
    return event.getProperty('LAST-MODIFIED').value;
  };
  ...
  event.getRecurrenceID = function() {
    return event.getProperty('RECURRENCE-ID');
  };
  ...
  event.getTransparency = function() {
    return event.getProperty('TRANSP').value;
  };
