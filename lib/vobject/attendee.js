...
module.exports = function() {
  ...
  attendee.setRole = function(role) {
    attendee.setParameter('ROLE', role.toUpperCase());
  };
  ...
  attendee.setRSVP = function(rsvp) {
    attendee.setParameter('RSVP', rsvp.toUpperCase());
  };
