...
module.exports = function() {
  ...
  todo.setDue = function(date) {
    ...
    return todo.setProperty(property);
  };
  ...
  // http://tools.ietf.org/html/rfc5545#section-3.8.2.1
  todo.setCompleted = function(date) {
    return todo.setProperty(new Property('COMPLETED', date.toICS()));
  };

  todo.getCompleted = function() {
    var property = todo.getProperty('COMPLETED');
