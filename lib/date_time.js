...
module.exports = function() {
  ...
  dateTime.parseISO8601 = function(dateTimeString) {
    dateTime.year = dateTimeString.substring(0, 4);
    dateTime.month = dateTimeString.substring(5, 7);
    dateTime.day = dateTimeString.substring(8, 10);
    dateTime.hours = dateTimeString.substring(11, 13);
    dateTime.minutes = dateTimeString.substring(14, 16);
    dateTime.seconds = dateTimeString.substring(17, 19);
