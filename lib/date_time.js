...
module.exports = function() {
  ...
  dateTime.parseOffset = function(offsetString) {
    var offsetHours = parseInt(offsetString.substring(0, 3), 10);
    var offsetMinutes = parseInt(offsetString.substring(4, 6), 10);
  ...
  dateTime.parseISO8601 = function(dateTimeString) {
    dateTime.year = parseInt(dateTimeString.substring(0, 4), 10);
    dateTime.month = parseInt(dateTimeString.substring(5, 7), 10);
    dateTime.day = parseInt(dateTimeString.substring(8, 10), 10);
    dateTime.hours = parseInt(dateTimeString.substring(11, 13), 10);
    dateTime.minutes = parseInt(dateTimeString.substring(14, 16), 10);
    dateTime.seconds = parseInt(dateTimeString.substring(17, 19), 10);

    // offset
    dateTime.parseOffset(dateTimeString.substring(19,25));
  };
